...
const PhoneLogin: React.FC<PhoneLoginProps> = ({ onBack, onSubmit, loading }) => {
  ...
  return (
    <PageTransition>
      <div className="px-6 py-8 h-[100dvh] bg-lightGray dark:bg-dark flex flex-col justify-between transition-colors overflow-hidden touch-none relative" dir="rtl">
        <div className="space-y-6">
          <button onClick={onBack} className="w-12 h-12 bg-white dark:bg-white/10 rounded-2xl flex items-center justify-center shadow-sm dark:shadow-none border border-transparent dark:border-white/5">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex-1 flex flex-col justify-between mt-8">
          <div className="space-y-6">
