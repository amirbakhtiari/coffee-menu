...
const TierDetail: React.FC = () => {
  ...
  const tierData = {
    bronze: {
      ...
      description: 'این اولین پله در دنیای کافه لند است. با عضویت در باشگاه و اولین سفارش، شما یک مشتری برنزی هستید و از مزایای پایه‌ای بهره‌مند خواهید شد.',
      benefits: [
    ...
    gold: {
      name: 'رده طلایی',
      points: '+۲,۵۰۰ امتیاز',
      description: 'بالاترین سطح وفاداری در کافه لند. مشتریان طلایی بخشی از خانواده درجه یک ما هستند و تجربه‌ای فراتر از یک کافه معمولی را لمس خواهند کرد.',
      benefits: [
            ...
            <div className="bg-primary/5 rounded-[32px] p-6 border border-primary/10 flex flex-row items-center gap-5">
              ...
              <div className="text-right">
                ...
                <p className="text-[10px] text-white/40 leading-relaxed font-medium">
                  با هر خرید از کافه لند، ۱۰٪ مبلغ فاکتور شما به امتیاز تبدیل می‌شود. کافیست شماره موبایل خود را هنگام سفارش اعلام کنید.
                </p>
              </div>
            </div>
          </section>
